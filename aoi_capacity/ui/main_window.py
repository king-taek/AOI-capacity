...
class MainWindow(QMainWindow):
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        # 9/23: 결과 HTML 과 같은 틀 — 위에 상단 바(브랜드 · 내비 · 마지막 수집), 아래에 페이지(가운데 정렬 · 최대 폭)
        ...
        page_wrap.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        wl = QHBoxLayout(page_wrap)
        wl.setContentsMargins(24, 20, 24, 16)
        self.stack.setMaximumWidth(1180)
        wl.addStretch(1)
        wl.addWidget(self.stack, 100)
        wl.addStretch(1)
